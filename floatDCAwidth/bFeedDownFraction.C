  ...
  for(int i=1; i<=nBinX; i++)
    {
      ...
      TH3D* hPtFile = (TH3D*)f->Get("hData");
      TH3D* hPtFileMB = (TH3D*)fMB->Get("hData");
      ...
      for(int k=0;k<nwidth;k++)
        {
          ...
          TH3D* hMCPSignalFile = (TH3D*)fMC->Get(Form("hMCPSignal_%d",k));
          TH3D* hMCNPSignalFile = (TH3D*)fMC->Get(Form("hMCNPSignal_%d",k));
          TH3D* hMCPSignalFileMB = (TH3D*)fMBMC->Get(Form("hMCPSignal_%d",k));
          TH3D* hMCNPSignalFileMB = (TH3D*)fMBMC->Get(Form("hMCNPSignal_%d",k));
          TH3D* hPtMD0DcaMCPSignalFile = (TH3D*)fMC->Get(Form("hPtMD0DcaMCPSignal_%d",k));
          TH3D* hPtMD0DcaMCPSwappedFile = (TH3D*)fMC->Get(Form("hPtMD0DcaMCPSwapped_%d",k));
          TH3D* hPtMD0DcaMCPSignalFileMB =(TH3D*)fMBMC->Get(Form("hPtMD0DcaMCPSignal_%d",k));
          TH3D* hPtMD0DcaMCPSwappedFileMB = (TH3D*)fMBMC->Get(Form("hPtMD0DcaMCPSwapped_%d",k));
