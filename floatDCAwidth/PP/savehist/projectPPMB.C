  ...
  for(int i=0;i<nwidth;i++)
    {
      ...
      tData->Draw(Form("DsvpvDistance/DsvpvDisErr:(DsvpvDistance*sin(Dalpha))*(1-%f):Dpt>>hSideband_%d",width,i),cutpt&&cutPPMb&&cutSideband);
      tData->Draw(Form("DsvpvDistance/DsvpvDisErr:(DsvpvDistance*sin(Dalpha))*(1-%f):Dpt>>hData_%d",width,i),cutpt&&cutPPMb&&cutSignal);
      tData->Draw(Form("(DsvpvDistance*sin(Dalpha))*(1-%f):Dmass:Dpt>>hPtMD0Dca_%d",width,i),cutpt&&cutPPMb);
    }
